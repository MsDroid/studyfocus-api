...
$tutors_qual_sql = "select * from tutor_qualification WHERE tutor_id = '${id}' ";
$tutors_qual_query = mysqli_query($con, $tutors_qual_sql);
$tutors_qual_data = mysqli_fetch_all($tutors_qual_query, MYSQLI_ASSOC);

// tutors
$tutors_sql = "select * from tutor_info WHERE id = '${id}' ";
$tutors_query = mysqli_query($con, $tutors_sql);
$tutors_data = mysqli_fetch_all($tutors_query, MYSQLI_ASSOC);

$get_sub_sql = "select subjects from tutor_info WHERE id = '${id}' ";
...
$res = array('tutors' => $tutors_data, 'qual' => $tutors_qual_data);
