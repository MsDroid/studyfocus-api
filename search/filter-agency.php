...
// $tutors_data = searchTutors($fields, 'tutor_info', $state_id, $city, $subjects);

// $agency_data = searchAgency($fields, 'agency_info', $state_id, $city, $subjects);
...
if($agency_data != ''){
	...
	echo json_encode(array('message'=>'success','status'=>201,'agency'=>$agency_data));
