...
<link rel='stylesheet' href='https://lextemplum.com/css/style.css' type='text/css' media='all' />
...
<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css' type='text/css' media='all' />
    ...
    <link href="../assets/css/fmain.css?v=200720v1" rel="stylesheet" />
...
if (!$email) {
	...
	echo "<script>window.open('https://lextemplum.com/login.php');</script>";
		}else{
...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="https://lextemplum.com/reset-password/reset-password.php?key='.$key.'&email='.$email.'&login_as='.$login_as.'&action=reset" target="_blank">https://lextemplum.com/reset-password/reset-password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';		
$output.='<p>-------------------------------------------------------------</p>';
...
$mail->SMTPSecure = "tls";      // sets the prefix to the servier
 ...
 $mail->Username = "noreply@lextemplum.com";  // Gmail username
 $mail->Password = "Lext2020"; 
$mail->IsHTML(true);
$mail->SetFrom ('noreply@lextemplum.com'); // send to mail
...
// </div><br /><br /><br />";
	...
	echo "<script>window.location = 'https://lextemplum.com/login.php';</script>";
