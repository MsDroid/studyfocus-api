<html>
<head>
<title>Reset Password: Lextemplum</title>
...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="https://thecybertize.com/projects/lex/reset-password/reset-password.php?key='.$key.'&email='.$email.'&login_as='.$login_as.'&action=reset" target="_blank">https://thecybertize.com/projects/lex/reset-password/reset-password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';		
$output.='<p>-------------------------------------------------------------</p>';
...
$mail = new PHPMailer();
// $mail->IsSMTP();
$mail->Host = "mail.lextemplum.com"; // Enter your host here
$mail->SMTPAuth = true;
$mail->Username = "admin@lextemplum.in"; // Enter your email here
$mail->Password = "12345678"; //Enter your passwrod here
$mail->Port = 25;
$mail->IsHTML(true);
$mail->From = "admin@lextemplum.com";
