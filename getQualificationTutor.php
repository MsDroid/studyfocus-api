...
$qual_sql = "select * from tutor_qualification WHERE id = '${id}' ";
$qual_query = mysqli_query($con, $qual_sql);
$qual_data = mysqli_fetch_all($qual_query, MYSQLI_ASSOC);


$res = array('qual' => $qual_data);
